...
class CPOTrainer(Trainer):
    ...
    def cpo_loss(
        ...
        def cosine_similarity_from_embeddings(
            ...
            # F.cosine_similarity computes pairwise cosine similarity across the specified dimension.
            # Here, dim=1 is the embedding dimension (e.g., 768, 1024), where the actual vector elements reside.
    ...
    def concatenated_forward(
        ...
        if self.aux_loss_enabled:
            return (num_non_pad_tokens, chosen_logps, rejected_logps, chosen_embeddings, rejected_embeddings, chosen_logits, nll_loss, outputs.aux_loss)

        return (num_non_pad_tokens, chosen_logps, rejected_logps, chosen_embeddings, rejected_embeddings, chosen_logits, nll_loss)
